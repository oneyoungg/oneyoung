...
public class ErrorMessage implements Serializable {
     ...
     * 对于没有参数的错误码 cache 起来
     */
    private static final Map<String, ErrorMessage> CACHED_MESSAGES = new ConcurrentHashMap<>(500);
    /**
     * the error code.
     */
    @Getter
...
//    }
    ...
    public static ErrorMessage code(@PropertyKey(resourceBundle = ErrorCode.BUNDLE) String key,
        ...
        if (params != null && params.length > 0) {
            ...
            CACHED_MESSAGES.computeIfAbsent(key, s -> ErrorCode.toErrorMessage(key, params));
            ErrorMessage message = CACHED_MESSAGES.computeIfAbsent(key, item -> ErrorCode.toErrorMessage(key, params));
    ...
    public static ErrorMessage of(String code,
                                  ...
                                  String readableCode,
                                  boolean isChineseDisplayMessage) {
        return new ErrorMessage(code, message, displayMessage, readableCode, isChineseDisplayMessage);
    }
